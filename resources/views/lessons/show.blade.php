                ...
                <div class="p-6">
                    ...
                    @if($lesson->attachment)
                        <div class="mt-6 p-4 bg-white border border-black rounded">
                            ...
                            <a href="{{ route('file.download', basename($lesson->attachment)) }}" download class="inline-flex items-center bg-black hover:bg-white hover:text-black border border-black text-white px-4 py-2 rounded">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                                Download: {{ basename($lesson->attachment) }}
                            </a>
                        </div>
                    @endif

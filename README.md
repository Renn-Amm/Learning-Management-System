...
### Student
- Can register as student on registration page
- Can browse all courses
- Can filter courses by category (Programming, Math, Business, Design)
...
### Teacher
- Can register as teacher on registration page
- Can create, edit, and delete courses
- Can add, edit, and delete lessons
- Can create new categories (Programming, Business, etc.)
...
2. Choose "Register as Student" or "Register as Teacher"
3. Fill in your name, email, and password
4. Click Register
5. You'll be automatically logged in with your chosen role

**Existing Users (Change Role Manually):**
```bash
php artisan tinker
```
```php
...
The system includes 4 default categories:
...
**For Students:**
- Can view all 20 courses on the courses page
- Can filter courses by clicking category buttons (Programming, Math, Business, Design)
- Category filter shows courses in selected category only

**For Teachers:**
- Can create new categories from the Categories page
- Assign a category when creating a course
- Can edit and delete categories (if no courses assigned)
...
4. Enter category name (e.g., "Science", "Languages", etc.)
5. Click "Create Category"
6. The new category will appear in course creation dropdown
...
3. See all 20 courses
4. Use category filter buttons to view courses by category (optional)
   - Click "All Courses" to see everything
   - Click "Programming", "Math", "Business", or "Design" to filter
